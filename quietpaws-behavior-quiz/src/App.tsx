...
export default function App() {
  ...
  const handleCTAClick = (e?: React.MouseEvent) => {
    ...
    if (typeof window.maxconv === 'function') {
      window.maxconv('event', 'click', {
        callback: () => { window.location.href = 'https://go.wisecombo.com/click'; }
      });
      // Fallback
      setTimeout(() => { window.location.href = 'https://go.wisecombo.com/click'; }, 1000);
    } else {
      window.location.href = 'https://go.wisecombo.com/click';
    }
  };
